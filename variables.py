...
float_num=10.452 # assign value to variable float_num.

boolean = True # assign value to variable boolean.

print (string) # output string 'daudi mwanja' to screen.

print (int_num) # output integer '10' to screen.
